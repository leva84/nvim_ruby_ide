...
vim.keymap.set('n', '<leader>rp', '<cmd>lua require("spectre").open_visual({select_word=true})<CR>', { desc = 'Замена слова под курсором (проект)' })
...
-- MARKDOWN PREVIEW
-- ============================================================================
vim.keymap.set('n', '<leader>mo', ':RenderMarkdown enable<CR>', { desc = 'Открыть Markdown preview' })
vim.keymap.set('n', '<leader>mc', ':RenderMarkdown disable<CR>', { desc = 'Закрыть Markdown preview' })
vim.keymap.set('n', '<leader>mt', ':RenderMarkdown toggle<CR>', { desc = 'Переключить Markdown preview' })
